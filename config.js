module.exports = {
  OWNER_IDS: [307881984649199616], // Bot owner ID's
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "966689317856641044", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
